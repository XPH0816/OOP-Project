...
public class Staff extends Person {
    ...
    public Invoice selectUserInvoice(InvoiceList invoiceList) throws NotAvaliable {
        ...
        int choice = helper.Validator.getInt("Enter your InvoiceID: ", 1, userInvoiceList.size());
        return userInvoiceList.searchByID(choice);
    }

    public void assignRoom(RoomList rooms) {
    ...
    public void checkout(RoomList rooms) {
